...
export function formatMessageForSummarizingContent(hexCoder:HexCoder,hexContent:string, category:string):Promise<Message<string>[]>{
    const markdownReader = createMarkdownReader();
